...
// ============================================================================
// Secteur: Hôpitaux (SCIAN 622)
// Profil de risques: CNESST Québec
// Lésions annuelles secteur: 35,000
...
// 🦠 BIOLOGIQUE: 22% des lésions - Priorité CRITIQUE
// 🧠 PSYCHOSOCIAL: 18% des lésions - Priorité ELEVE
// 🧪 CHIMIQUE: 8% des lésions - Priorité ELEVE
// ⚠️ VIOLENCE: 7% des lésions - Priorité ELEVE
// ☢️ RADIATION: 5% des lésions - Priorité ELEVE
//
// CERTIFICATIONS REQUISES: SIMDUT, PDSB, RCR, Prévention infections, Radioprotection
// EPI CRITIQUES: gants, masque N95, blouse, lunettes, tablier plombé
// ============================================================================
...
// ============================================================================
// 3. 🦠 RISQUES BIOLOGIQUE - 22% des lésions (CRITIQUE)
// ============================================================================
...
// ============================================================================
// 4. 🧠 RISQUES PSYCHOSOCIAL - 18% des lésions (ELEVE)
// ============================================================================
...
WHERE o.sector_scian IN ['622']
  AND (r.categorie = 'psychosocial' OR toLower(r.description) CONTAINS 'épuisement' OR toLower(r.description) CONTAINS 'violence' OR toLower(r.description) CONTAINS 'harcèlement' OR toLower(r.description) CONTAINS 'surcharge' OR toLower(r.description) CONTAINS 'burnout' OR toLower(r.description) CONTAINS 'stress')
  AND r.probabilite * r.gravite >= 10
  AND (p.certifications_sst IS NULL OR NOT 'SIMDUT' IN p.certifications_sst OR NOT 'PDSB' IN p.certifications_sst)
RETURN DISTINCT p.matricule AS travailleur,
       z.name AS zone,
       p.certifications_sst AS certifications_actuelles,
       'SIMDUT, PDSB, RCR' AS certifications_recommandees
LIMIT 30;



// ============================================================================
// 5. 🧪 RISQUES CHIMIQUE - 8% des lésions (ELEVE)
// ============================================================================
...
// ============================================================================
// 6. ⚠️ RISQUES VIOLENCE - 7% des lésions (ELEVE)
// ============================================================================
...
// ============================================================================
// ✅ CONFORMITÉ ET AUDIT - RSST, Loi sur les services de santé, INSPQ
// ============================================================================
...
// Vérification certifications requises secteur: SIMDUT, PDSB, RCR, Prévention infections, Radioprotection
MATCH (o:Organization)<-[:APPARTIENT_A]-(t:Team)<-[:MEMBRE_DE]-(p:Person)
WHERE o.sector_scian IN ['622']
WITH p, p.certifications_sst AS certs
WHERE certs IS NULL OR size([c IN certs WHERE c IN ['SIMDUT', 'PDSB', 'RCR', 'Prévention infections', 'Radioprotection']]) < 2
RETURN p.matricule AS travailleur,
       certs AS certifications_actuelles,
       'SIMDUT, PDSB, RCR' AS certifications_prioritaires
LIMIT 50;
...
// ============================================================================
// FIN DES REQUÊTES GÉNÉRÉES POUR SCIAN 622 - HÔPITAUX
